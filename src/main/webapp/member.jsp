...
<script>
 (function () {
  ...
  sendFile = function (file) {
    ...
    requestt.open("POST", 'https:/fortika-he-component.xlab.si/uploadFile');
    requestt.withCredentials = true;
   // requestt.onreadystatechange = handler;
   // requestt.setRequestHeader("Content-Type", "application/json");
    //  requestt.setRequestHeader("Access-Control-Allow-Origin: ", "*");
    requestt.send(formData);
  };
})();
</script> 
